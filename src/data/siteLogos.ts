...
export const headerOrganizationalLogos: SiteLogo[] = [
  // Example — add files to public/images/org/ then uncomment:
  // { src: '/images/org/compass-logo.svg', alt: 'Compass Detroit', href: 'https://compassdetroit.com' },
];

/** Shown in the site footer (sponsors, supporters). */
export const footerSponsorLogos: SiteLogo[] = [
  { src: '/images/site/compass-logo.svg', alt: 'Compass Detroit', href: 'https://compassdetroit.com' },
];
